...
function(do_fetch)
  ...
  execute_process(
    COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git fetch --tags --force "origin"
    WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
...
execute_process(
  COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "1.0.7"
  WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("1.0.7" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/1.0.7")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"1.0.7\" is not present locally, and not "
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
...
execute_process(
  COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src'."
    ...
    execute_process(
      COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
    )
    execute_process(
      COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src"
      )
      execute_process(
        COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/user/Desktop/Programming/Projects/neural_network_SDL/build/clang/_deps/highway-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "C:/Users/user/AppData/Local/Programs/Git/cmd/git.exe"
            --git-dir=.git 
